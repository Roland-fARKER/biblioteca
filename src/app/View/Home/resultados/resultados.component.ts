...
export class ResultadosComponent {
  ...
  libroFavorito(index: number, nombre: string) {
    this.librosIn[index].esFavorito = !this.librosIn[index].esFavorito;

    this.librosIn[index].esFavorito
  ...
  esFavorito(index: number): boolean {
    return this.librosIn[index].esFavorito;
  }
